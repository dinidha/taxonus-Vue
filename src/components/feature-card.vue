<template>
  <div class="featuresCard feature-card-feature-card" v-bind:class="rootClassName"
...
export default {
  ...
  props: {
    heading: {
      type: String,
      default: 'Tax advisory',
    },
    rootClassName: String,
    subHeading: {
      type: String,
      default: 'Obtain Tax advisory services from our expert team.',
    },
  },
}
</script>
